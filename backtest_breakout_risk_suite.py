...
ENTRY_CASES = [
    {
        "entry_case": "TREND040_PC055_VOL25_SCORE5_INIT",
        "min_score": 5,
        "need_initiative": 1,
        "max_pc": 0.55,
        "max_vol": 25.0,
    ...
    {
        "entry_case": "TREND030_PC055_VOL25_SCORE5_INIT",
        "min_score": 5,
        "need_initiative": 1,
        "max_pc": 0.55,
        "max_vol": 25.0,
    ...
    {
        "entry_case": "TREND040_PC065_VOL35_SCORE5_INIT",
        "min_score": 5,
        "need_initiative": 1,
        "max_pc": 0.65,
        "max_vol": 35.0,
    ...
    {
        "entry_case": "TREND030_PC065_VOL35_SCORE5_INIT",
        "min_score": 5,
        "need_initiative": 1,
        "max_pc": 0.65,
        "max_vol": 35.0,
...
async def run(args):
    ...
    print(f"🚀 SKYNET BREAKOUT RISK SUITE | days={args.days} top={args.top} max_open={max_open_values}")
